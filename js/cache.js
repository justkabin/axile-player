(function (window, $){
	"use strict"	
	var AXILECacheManager = function(cid){
		...
		if("indexedDB" in window) {
	        ...
	        openRequest.onsuccess = function(e) {
				...
				//$(self).trigger("AXILECacheManager.DB_READY");
				self.getData();
	        }
		...
		this.getData = function() {
		    ...
		    request.onsuccess = function(e) {
		        ...
		        $(self).trigger("AXILECacheManager.GET_DATA", result);
		    } 
		    request.onerror = function (e) {
                console.log("Error",e.target.error.name);
            };
	...
	window.AXILECacheManager = AXILECacheManager;
